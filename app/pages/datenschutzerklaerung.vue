<template>
  <div class="container mx-auto pt-36 p-4 text-neutral-200">
    ...
    <h4 class="text-neutral-200 text-xl uppercase font-bold">
    ...
    <h3 class="text-neutral-200 text-2xl uppercase font-bold mt-3">Strato</h3>
    <p>
    ...
    <h3 class="text-neutral-200 text-2xl uppercase font-bold mt-3">Cookies</h3>
    <p>
    ...
    <p>
      ...
      Web Fonts von Adobe. Anbieter ist die Adobe Systems Incorporated, 345 Park
      Avenue, San Jose, CA 95110-2704, USA (Adobe).
    </p>
    <p>
      Beim Aufruf dieser Website l&auml;dt Ihr Browser die ben&ouml;tigten
      ...
      von Adobe in den USA her. Hierdurch erlangt Adobe Kenntnis dar&uuml;ber,
      dass &uuml;ber Ihre IP-Adresse diese Website aufgerufen wurde. Bei der
      Bereitstellung der Schriftarten werden nach Aussage von Adobe keine
      Cookies gespeichert.
    </p>
    <p>
      ...
      DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung
    ...
    <p>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        >https://www.dataprivacyframework.gov/s/participant-search/participant-detail?contact=true&id=a2zt0000000TNo9AAG&status=Active</a
      >.
    </p>
    <h2 class="text-neutral-200 text-4xl uppercase font-bold mt-4">
      6. eCommerce und Zahlungs&shy;anbieter
    </h2>
    <h3 class="text-neutral-200 text-2xl uppercase font-bold mt-3">
